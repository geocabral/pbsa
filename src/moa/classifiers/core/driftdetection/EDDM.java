...
public class EDDM extends AbstractChangeDetector {
    ...
    private static final double FDDM_OUTCONTROL = 0.95;

    private static final double FDDM_WARNING = 0.9;

    //varies from 50 to 250
    public static double FDDM_MINNUMINSTANCES = 150;

    private double m_numErrors;
    //varies from 5 to 30
    public static int m_minNumErrors = 5;
    ...
    public boolean updateConcept = true;
