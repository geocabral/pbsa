...
public class EnsembleDriftDetectionMethods extends AbstractChangeDetector {
    ...
    public void input(double prediction) {
        ...
        if (typePrediction == 0) { 
            //Choose Max
            this.isChangeDetectedClass0 = (numberDetections == cds.length);
        } else if (typePrediction == 1) {
            //Choose Min
             this.isChangeDetectedClass0 = (numberDetections > 0);
        } else if (typePrediction == 2) {
            //Choose Avg
            this.isChangeDetectedClass0 = (numberDetections > cds.length/2) ;
        }
        if (this.isChangeDetectedClass0 == true) {
            this.resetLearning();
        }
    }
