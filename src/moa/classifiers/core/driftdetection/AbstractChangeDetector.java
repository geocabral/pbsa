...
public abstract class AbstractChangeDetector extends AbstractOptionHandler
    ...
    /**
     * Change was detected for class 0
     */
    protected boolean isChangeDetectedClass0;

    /**
     * Change was detected for class 1
     */
    protected boolean isChangeDetectedClass1;
    ...
    public double[] getOutput() {
        double[] res = {this.isChangeDetectedClass0 ? 1 : 0, this.isWarningZone ? 1 : 0, this.delay, this.estimation};
        return res;
    }
