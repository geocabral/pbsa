...
public class EWMAChartDM extends AbstractChangeDetector {
    ...
    //varies from 30 to 500
    public static int minNumInstancesOptionParam = 30;
    public IntOption minNumInstancesOption = new IntOption(
            "minNumInstances",
            'n',
            "The minimum number of instances before permitting detecting change.",
            minNumInstancesOptionParam , 0, Integer.MAX_VALUE);

    //varies from 0.05 to 0.5
    public static double lambdaParam = 0.2;
    public FloatOption lambdaOption = new FloatOption("lambda", 'l',
            "Lambda parameter of the EWMA Chart Method", lambdaParam, 0.0, Float.MAX_VALUE);
    ...
    public void input(double prediction) {
        ...
        // It monitors the error rate
         if (this.isChangeDetectedClass0 == true || this.isInitialized == false) {
            resetLearning();
