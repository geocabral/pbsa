...
public class DynamicWeightedMajority extends AbstractClassifier implements MultiClassClassifier {
    ...
    public IntOption periodOption = new IntOption("period", 'z',
            "Period between expert removal, creation, and weight update.", 10,
            1, Integer.MAX_VALUE);

    public FloatOption betaOption = new FloatOption("beta", 'b',
            "Factor to punish mistakes by.", 0.4, 0.0, 1.0);

    public FloatOption thetaOption = new FloatOption("thetadwm", 'x',
            "Minimum fraction of weight per model.", 0.1, 0.0, 1.0);

    public IntOption maxExpertsOption = new IntOption("maxExperts", 'e',
            "Maximum number of allowed experts.", Integer.MAX_VALUE, 20,
            Integer.MAX_VALUE);

    public List<Classifier> experts;
