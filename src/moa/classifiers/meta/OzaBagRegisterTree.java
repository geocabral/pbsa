 ...
 * @version $Revision: 7 $
 */
public class OzaBagRegisterTree extends AbstractClassifier implements MultiClassClassifier {
	...
	public double[] getVotesForInstance(Instance inst) {
		...
		try {
			...
			if(writerRoot == null){
				writerRoot = new FileWriter("RQ4/roots"+currentdataset+"OOBMix.txt");	
			}
			
			if(writerSubRoot == null){
				writerSubRoot = new FileWriter("RQ4/subRoots"+currentdataset+"OOBMix.txt");	
			}
