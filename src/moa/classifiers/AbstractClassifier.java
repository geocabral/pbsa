...
public abstract class AbstractClassifier extends AbstractOptionHandler implements Classifier { // Learner<Example<Instance>>
																								// {
	...
	public Measurement[] getModelMeasurements() {
		...
		// List<Measurement[]> subMeasurements = new
		// LinkedList<Measurement[]>();
		...
		// Measurement.averageMeasurements(subMeasurements.toArray(new
		// Measurement[subMeasurements.size()][]));
