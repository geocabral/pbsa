 ...
 *
 */
public class RealTimeRecallsChart extends ApplicationFrame implements ActionListener {
     ...
     */
    public RealTimeRecallsChart(final String title) {
...
//        chart.getLegend().setAnchor(Legend.EAST);
  ...
  //      plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 4, 4, 4, 4));
    ...
    public static void main(final String[] args) {
        ...
        final RealTimeRecallsChart demo = new RealTimeRecallsChart("Dynamic Data Demo 3");
        demo.pack();
